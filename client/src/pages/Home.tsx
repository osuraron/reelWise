                  ...
                  {recommendation && (
                    <div className="featured-card">
                      ...
                      <div className="relative flex flex-col justify-between p-6 sm:p-8 lg:p-10">
                        {fitScore !== null && <span aria-label={`Reelwise personalized fit ${fitScore} percent`} className="absolute right-6 top-5 font-serif text-[clamp(2.2rem,4vw,3.8rem)] leading-none tracking-[-0.07em] text-[#d94f3d] sm:right-8 sm:top-7 lg:right-10 lg:top-8">{fitScore}%</span>}
                        <div>
