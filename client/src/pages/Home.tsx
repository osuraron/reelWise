...
function Onboarding({ onComplete }: { onComplete: (profile: TasteProfile) => void }) {
  ...
  return (
    <main className="dark-cinema min-h-screen overflow-hidden bg-[#080808] px-5 py-7 text-[#f6efe2] sm:px-8 sm:py-10">
      <div className="paper-grain" aria-hidden="true" />
      <div className="relative mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-5xl flex-col border border-[#f6efe2]/15 bg-[#111111]/95 px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,.48)] sm:px-10 sm:py-11">
...
export default function Home() {
  ...
  return (
    <div className="dark-cinema min-h-screen overflow-x-hidden bg-[#080808] text-[#f6efe2]">
      <div className="paper-grain" aria-hidden="true" />
